...
import { generateQuickSortSteps } from "./logic";
import { QuickSortCanvas } from "./Canvas";
...
export default function QuickSortVisualization() {
  ...
  const steps = useMemo(() => generateQuickSortSteps(input), [input]);
  ...
  return (
    <div className="space-y-4">
      ...
      />
      <Player steps={steps}>
        {(currentStep) => <QuickSortCanvas step={currentStep} />}
      </Player>
    </div>
  );
}
