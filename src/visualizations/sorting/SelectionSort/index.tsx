...
import { generateSelectionSortSteps } from "./logic";
import { SelectionSortCanvas } from "./Canvas";
...
export default function SelectionSortVisualization() {
  ...
  const steps = useMemo(() => generateSelectionSortSteps(input), [input]);
  ...
  return (
    <div className="space-y-4">
      ...
      />
      <Player steps={steps}>
        {(currentStep) => <SelectionSortCanvas step={currentStep} />}
      </Player>
    </div>
  );
}
